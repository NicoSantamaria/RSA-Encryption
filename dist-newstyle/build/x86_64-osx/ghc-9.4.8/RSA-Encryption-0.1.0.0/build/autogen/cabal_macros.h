...
/* package RSA-Encryption-0.1.0.0 */
#ifndef VERSION_RSA_Encryption
#define VERSION_RSA_Encryption "0.1.0.0"
#endif /* VERSION_RSA_Encryption */
#ifndef MIN_VERSION_RSA_Encryption
#define MIN_VERSION_RSA_Encryption(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_RSA_Encryption */
...
#define CURRENT_PACKAGE_KEY "RSA-Encryption-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "RSA-Encryption-0.1.0.0-inplace"
